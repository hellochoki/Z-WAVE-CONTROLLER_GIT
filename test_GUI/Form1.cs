...
namespace ZWave_Controller
{
    public partial class Form1 : Form
    {
        ...
        private void btn4_Click(object sender, EventArgs e)
        {
            ...
            {
                Send_command.RunCommand_Nonsecurity(controller, real_dst, real_command, 1);
            }
            else
            {
                ...
                do
                {
                    if(cnt == 0) // first packet
                    {
                        ...
                        len = len - 40;
                        Send_command.RunCommand_Nonsecurity(controller, real_dst, Seg_Command, 1);
                    ...
                    else // subsequent packet
                    {
                        ...
                        else
                        {
                            ...
                            len = 0;
                            Send_command.RunCommand_Nonsecurity(controller, real_dst, Seg_Command2, 1);
                ...
                Send_command.RunCommand_Nonsecurity(controller, real_dst, segment_complete, 1);
                cnt = 0;
            }
