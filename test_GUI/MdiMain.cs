...
namespace ZWave_Controller
{
    public partial class MdiMain : Form
    {
        ...
        private void btn4_Click(object sender, EventArgs e)
        {
            ...
            dump_command = null;
            int number = 1;
            Send_command.RunCommand_Nonsecurity(controller, real_dst, real_command, number);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            label_PortStatus.ForeColor = System.Drawing.Color.Blue;
            label_PortStatus.Text = "PortStatus : disconnected (re-connect)";
        }
        ...
        private void btn6_Click(object sender, EventArgs e)
        {
            ...
            Send_command.RunCommand_Nonsecurity(controller, real_dst_for_enc, nonce_get_command, 1);
        }
